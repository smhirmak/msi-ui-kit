...
const apiTableData = [
  {
    prop: 'theme',
    type: '"default" | "lined" | "colored"',
    default: '"default"',
    description: 'The visual theme variant',
  },
  { prop: 'mode', type: '"light" | "dark"', default: '"light"', description: 'Light or dark mode' },
  {
    prop: 'animation',
    type: '"bounce" | "slide" | "flip" | false',
    default: '"bounce"',
    description: 'Animation type for notification',
  },
  {
    prop: 'position',
    type: '"top-right" | "bottom-right" | "top-left" | "bottom-left"',
    default: '"top-right"',
    description: 'Position of notification on screen',
  },
  {
    prop: 'autoClose',
    type: 'number | false',
    default: '5000',
    description: 'Auto close delay in milliseconds, or false to disable',
  },
];

const NotificationPage = () => {
  const { info, success, error, warn } = Notification();
  const { setNotificationTheme, setNotificationAnimateMode, setNotificationPosition } =
    useAppContext();
    ...
    <div className="space-y-12">
      ...
      <section id="overview">
        ...
        <p className="text-lg text-neutral-grey">
          A flexible notification system with multiple themes, animations, and positioning options
          for displaying user feedback.
        </p>
      </section>
      ...
      <section id="usage">
        ...
        <div className="space-y-4">
          <p className="text-neutral-grey">
            Basic notification usage with different severity levels.
          </p>
          <div className="rounded-lg border border-border bg-background p-6">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              ...
              <Button
                ...
                className="bg-success text-neutral-black"
              >
                Success
              </Button>
              <Button
                onClick={() => warn('Warning')}
                className="bg-warning text-neutral-white"
              >
                Warning
              </Button>
              <Button
          ...
          <CustomSyntaxHighlighter
            content={`const { info, success, error, warn } = Notification();
...
error('Error message');`}
      ...
      <section id="themes">
        ...
        <div className="space-y-4">
          <p className="text-neutral-grey">
            Choose from different theme variants for your notifications.
          </p>
          <div className="rounded-lg border border-border bg-background p-6">
            <RadioGroup
              defaultValue="default"
              onChange={(e) => setNotificationTheme(e as 'default' | 'lined' | 'colored')}
          ...
          <CustomSyntaxHighlighter
            content={`// Set notification theme
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-background p-6">
            <RadioGroup
              ...
              onChange={(e) => setNotificationPosition(e as 'top-right' | 'bottom-right')}
              className="flex w-fit flex-col gap-2 rounded-md bg-primary-15 p-4"
            >
              <RadioGroupItem
                id="top-right"
          ...
          <CustomSyntaxHighlighter
            content={`// Set notification position
setNotificationPosition('top-right'); // or 'bottom-right', 'top-left', 'bottom-left'`}
        ...
        <div className="mt-8 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <Button
                    onClick={() => success('Success', { autoClose: false })}
                    className="bg-success hover:bg-success/75 text-neutral-black"
                  >
                    Success
                  </Button>
                  <Button
                    onClick={() => warn('Warning', { autoClose: false })}
                    className="bg-warning hover:bg-warning/75 text-neutral-white"
                  >
                    Warning
                  </Button>
                  <Button
                    onClick={() => error('Error', { autoClose: false })}
                    className="bg-error hover:bg-error/75"
                  >
                    Error
                  </Button>
          ...
          <CustomSyntaxHighlighter
            content={`// With auto close (default - 5000ms)
